...
-- This replaces the MongoDB models with PostgreSQL tables
...
-- Incidents - users can see incidents they reported or are assigned to
...
-- Documents - users can see documents for incidents they have access to
...
-- Monitoring alerts - users with appropriate roles can view
